				...
				for (double i = 21; i > 0; i--) {
					...
					Platform.runLater(new Runnable() {
						...
						public void run() {
							...
							updateCanvas(); // CAUTION: This method contains UI update, which can cause an error if
		...
		Thread t = new Thread(() -> {
			try {
				...
				Platform.runLater(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						GameLogic.endTurns(); // CAUTION: This method contains UI update, which can cause an error if
												// running
