	...
	public KeyboardPane() {
		...
		for (int i = 0; i < 3; i++) {
			...
			for (String s : keyArray[i]) {
				...
				/*
				 * FILL CODE: Clicking this button should call a static method
				 * addLetterToCurrentPlayer(String s) from the class GameLogic.
				 */

				kB.setOnAction(new EventHandler<ActionEvent>() {
