...
public class GameLogic {
	...
	public static void startCountDownTimer(int pl) {
		/*
		 * FILL CODES The following code will make the timer starts counting down. But
		 * it will not work if got called by the main application thread.
		 */
	...
	public static void runCountDownTimer(int pl) throws InterruptedException {
		...
		while (isTurnActive && !plTimer.isTimerEmpty()) {
			...
			/*
			 * FIX CODE: The following code contains UI update, which can cause an error if
			 * running in a different thread. You need to alter the code to make this works.
			 */
	...
	public static void endGame() {
		...
		/*
		 * FILL CODE Create an Alert here, set all proper details and show it When
		 * closed, check for the result and do the following: If the player has click
		 * YES: call resetGame(); method Otherwise, call Platform.exit(); to close the
		 * game.
		 * 
